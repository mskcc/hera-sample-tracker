...
class SearchForm extends Component {
    ...
    render() {
		...
		<Row type="flex" justify="center">
			<Col span={10} >
				<Text strong>The CMO repository of WES data was generated by re-capturing DNA leftover from MSK-IMPACT for patients who consented to IRB #12-245. Please review the CMO WES Repository terms of use <a href="https://cmo.mskcc.org/cmo/resources/wes-repository-terms-of-use/">here.</a></Text>
			</Col>
		</Row>
		<br/>
		<Row type="flex" justify="center">
			<Col span={10} >
				<Text strong>For questions related to TEMPO analysis pipeline output, please visit the <a href="https://ccstempo.netlify.app/#table-of-contents">TEMPO website</a> or email the <a href="mailto:zzPDL_CMO_TEMPO_Support@mskcc.org?subject=Tempo Analysis Enquiry">CMO Computational Science (CCS) Team.</a> (zzPDL_CMO_TEMPO_Support@mskcc.org) </Text>
			</Col>
		</Row>
		<br/>
		<Row type="flex" justify="center">
			<Col span={10} >
				<Text strong>An explanation of values in the Tempo QC Status column can be found on the Tempo website <a href="https://ccstempo.netlify.app/bioinformatic-components.html#multiqc-report">here.</a></Text>
			</Col>
		</Row>
